...
class QuantityRecipeDialogWidget extends StatelessWidget {
  final RxString recipeQuantity;
  final Rx<Recipe?> selectedRecipe;
              ...
              children: [
                Container(
                  ...
                  child: SmallActionButton(
                    ...
                    backgroundColor: selectedRecipe.value?.attributes != null
          ...
          Container(
            ...
            child: Obx(() {
              return SelectedIngredientRecipeItem(
                theme: theme!,
                selectedItemName: selectedRecipe.value?.attributes?.name ??
                ...
                quantityValue: recipeQuantity.value,
                isChecked: selectedRecipe.value?.attributes != null,
              );
            }),
          ),
        ],
